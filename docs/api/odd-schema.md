...
release). JATS / DocBook set another `@ns` and skip that base. `use_guidelines`
(`opm odd document` without SOURCE) documents TEI alone; it is not shipped in the wheel.
