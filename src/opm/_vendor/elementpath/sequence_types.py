...
from opm._vendor.elementpath.datatypes import builtin_atomic_types, builtin_list_types, QName, \
    NumericProxy, AnyAtomicType
from opm._vendor.elementpath.exceptions import ElementPathKeyError, ElementPathValueError, xpath_error
from opm._vendor.elementpath.namespaces import XSD_NAMESPACE, XSD_ERROR, XSD_DATETIME_STAMP, \
    XSD_NUMERIC, XSD_UNTYPED, XSD_UNTYPED_ATOMIC, get_expanded_name
from opm._vendor.elementpath.helpers import collapse_white_spaces, Patterns
from opm._vendor.elementpath.xpath_nodes import XPathNode, DocumentNode, ElementNode, AttributeNode
from opm._vendor.elementpath.xpath_tokens import XPathToken
