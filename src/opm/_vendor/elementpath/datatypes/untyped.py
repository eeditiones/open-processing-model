...
from opm._vendor.elementpath.aliases import XPath2ParserType
from opm._vendor.elementpath.helpers import reversed_sub, reversed_truediv, BOOLEAN_VALUES, get_double
