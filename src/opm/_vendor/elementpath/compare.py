...
from opm._vendor.elementpath.protocols import ElementProtocol
from opm._vendor.elementpath.exceptions import xpath_error
from opm._vendor.elementpath.datatypes import UntypedAtomic, AnyURI, AbstractQName
from opm._vendor.elementpath.collations import UNICODE_CODEPOINT_COLLATION, CollationManager
from opm._vendor.elementpath.xpath_nodes import XPathNode, EtreeElementNode, TextAttributeNode, \
    NamespaceNode, TextNode, CommentNode, ProcessingInstructionNode, EtreeDocumentNode
from opm._vendor.elementpath.xpath_tokens import XPathToken, XPathFunction, XPathMap, XPathArray
