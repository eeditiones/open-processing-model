...
from opm._vendor.elementpath.protocols import ElementProtocol, DocumentProtocol, EtreeElementProtocol, \
    LxmlElementProtocol
from opm._vendor.elementpath.exceptions import XMLResourceForbidden, ElementPathOSError
