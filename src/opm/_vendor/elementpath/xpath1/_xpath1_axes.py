...
from opm._vendor.elementpath.xpath_nodes import XPathNode, AttributeNode, ElementNode, NamespaceNode
from opm._vendor.elementpath.xpath_context import XPathSchemaContext
from opm._vendor.elementpath.xpath_tokens import XPathAxis
