...
from opm._vendor.elementpath.namespaces import XML_ID, XML_LANG
from opm._vendor.elementpath.datatypes import AnyURI, Float, DayTimeDuration, YearMonthDuration, \
    StringProxy, AnyAtomicType, Duration
from opm._vendor.elementpath.helpers import get_double
from opm._vendor.elementpath.xpath_nodes import XPathNode, ElementNode, TextNode, CommentNode, \
