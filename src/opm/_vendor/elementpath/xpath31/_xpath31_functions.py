...
import opm._vendor.elementpath.aliases as ta

from opm._vendor.elementpath.protocols import ElementProtocol, EtreeElementProtocol
from opm._vendor.elementpath.exceptions import ElementPathTypeError
from opm._vendor.elementpath.datatypes import AbstractBinary, AbstractDateTime, AnyAtomicType, \
    Base64Binary, BooleanProxy, DateTime, DoubleProxy, DoubleProxy10, Duration, \
    Language, NumericProxy, Timezone, UntypedAtomic
from opm._vendor.elementpath.namespaces import XML_BASE, XPATH_FUNCTIONS_NAMESPACE
from opm._vendor.elementpath.helpers import collapse_white_spaces, is_xml_codepoint, \
    escape_json_string, unescape_json_string, not_equal, is_allowed_uri
from opm._vendor.elementpath.sequences import xlist
from opm._vendor.elementpath.etree import etree_iter_strings, is_etree_element
from opm._vendor.elementpath.collations import CollationManager
from opm._vendor.elementpath.compare import get_key_function, same_key
from opm._vendor.elementpath.tree_builders import get_node_tree
from opm._vendor.elementpath.xpath_nodes import XPathNode, DocumentNode, EtreeElementNode
from opm._vendor.elementpath.xpath_tokens import XPathFunction, XPathConstructor, XPathMap, XPathArray
from opm._vendor.elementpath.xpath_context import XPathSchemaContext
from opm._vendor.elementpath.validators import validate_json_to_xml
