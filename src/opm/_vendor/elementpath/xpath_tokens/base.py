...
from opm._vendor.elementpath.exceptions import xpath_error, ElementPathError, ElementPathValueError, \
    ElementPathTypeError, MissingContextError
from opm._vendor.elementpath.namespaces import XSD_ANY_TYPE, XSD_ANY_SIMPLE_TYPE, XSD_ANY_ATOMIC_TYPE
from opm._vendor.elementpath.namespaces import XSD_NAMESPACE, XPATH_MATH_FUNCTIONS_NAMESPACE
from opm._vendor.elementpath.datatypes import AnyAtomicType, AbstractDateTime, AnyURI, \
    DayTimeDuration, Date, DateTime, DecimalProxy, Duration, Integer, QName, \
    Timezone, UntypedAtomic, AbstractQName
from opm._vendor.elementpath.tdop import Token, MultiLabel
from opm._vendor.elementpath.helpers import ordinal, get_double
from opm._vendor.elementpath.xpath_context import XPathContext, XPathSchemaContext
from opm._vendor.elementpath.xpath_nodes import XPathNode, NamespaceNode, DocumentNode, ElementNode
