...
from opm._vendor.elementpath.namespaces import XSD_NAMESPACE, XPATH_FUNCTIONS_NAMESPACE, XMLNS_NAMESPACE
from opm._vendor.elementpath.namespaces import get_expanded_name
from opm._vendor.elementpath.datatypes import AnyAtomicType, AnyURI, UntypedAtomic, ArithmeticProxy, \
    YearMonthDuration, DayTimeDuration, Duration, AbstractDateTime
from opm._vendor.elementpath.helpers import collapse_white_spaces
from opm._vendor.elementpath.sequences import xlist
from opm._vendor.elementpath.xpath_nodes import AttributeNode, ElementNode
