...
from opm._vendor.elementpath.tdop import MultiLabel
from opm._vendor.elementpath.helpers import Patterns, is_xml_codepoint, node_position, \
    is_allowed_variable, is_allowed_uri
from opm._vendor.elementpath.namespaces import get_expanded_name, split_expanded_name, \
    XPATH_FUNCTIONS_NAMESPACE
from opm._vendor.elementpath.datatypes import NumericProxy, QName, Date, DateTime, Time, AnyURI
from opm._vendor.elementpath.sequences import xlist
from opm._vendor.elementpath.sequence_types import is_sequence_type, match_sequence_type
from opm._vendor.elementpath.etree import defuse_xml
from opm._vendor.elementpath.xpath_nodes import XPathNode, ElementNode, NamespaceNode, \
    DocumentNode, EtreeElementNode, SchemaElementNode
from opm._vendor.elementpath.tree_builders import get_node_tree
from opm._vendor.elementpath.xpath_tokens import XPathToken, ValueToken, XPathFunction
from opm._vendor.elementpath.serialization import get_serialization_params, serialize_to_xml, \
    serialize_to_json
from opm._vendor.elementpath.xpath_context import XPathContext, XPathSchemaContext
from opm._vendor.elementpath.regex import translate_pattern, RegexError
