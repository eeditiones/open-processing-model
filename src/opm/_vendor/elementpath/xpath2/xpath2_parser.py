...
from opm._vendor.elementpath.helpers import upper_camel_case, is_ncname
from opm._vendor.elementpath.exceptions import ElementPathTypeError, ElementPathValueError, xpath_error
from opm._vendor.elementpath.namespaces import XML_NAMESPACE, XSD_NAMESPACE, XPATH_FUNCTIONS_NAMESPACE, \
    XQT_ERRORS_NAMESPACE, XSD_NOTATION, XSD_ANY_ATOMIC_TYPE
from opm._vendor.elementpath.namespaces import get_prefixed_name
from opm._vendor.elementpath.datatypes import QName, builtin_atomic_types
from opm._vendor.elementpath.collations import UNICODE_COLLATION_BASE_URI, UNICODE_CODEPOINT_COLLATION
from opm._vendor.elementpath.xpath_tokens import XPathToken, ProxyToken, XPathFunction, \
    XPathConstructor, SchemaConstructor, ExternalFunction
from opm._vendor.elementpath.sequence_types import get_function_signatures, is_sequence_type, \
    match_sequence_type
from opm._vendor.elementpath.schema_proxy import AbstractSchemaProxy
from opm._vendor.elementpath.xpath1 import XPath1Parser
