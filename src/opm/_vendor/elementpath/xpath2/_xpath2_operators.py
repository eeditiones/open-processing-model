...
from opm._vendor.elementpath.protocols import XsdAttributeProtocol
from opm._vendor.elementpath.exceptions import ElementPathError
from opm._vendor.elementpath.namespaces import XSD_NAMESPACE, XSD_NOTATION, XSD_ANY_ATOMIC_TYPE, XSD_UNTYPED
from opm._vendor.elementpath.helpers import numeric_equal, numeric_not_equal, \
    node_position, get_double
from opm._vendor.elementpath.namespaces import XSD_ERROR, get_namespace, get_expanded_name
from opm._vendor.elementpath.datatypes import UntypedAtomic, QName, AnyURI, \
    Duration, Integer, DoubleProxy10
from opm._vendor.elementpath.xpath_nodes import ElementNode, DocumentNode, XPathNode, AttributeNode
from opm._vendor.elementpath.sequences import xlist
from opm._vendor.elementpath.sequence_types import is_instance
from opm._vendor.elementpath.xpath_context import XPathSchemaContext
from opm._vendor.elementpath.xpath_tokens import XPathToken, XPathFunction, XPathConstructor
