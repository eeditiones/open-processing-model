...
from opm._vendor.elementpath.exceptions import ElementPathRuntimeError, \
    ElementPathValueError, ElementPathKeyError
from opm._vendor.elementpath.datatypes import UntypedAtomic, AnyURI, QName
from opm._vendor.elementpath.namespaces import XML_NAMESPACE, XML_BASE, XSI_NIL, \
...
from opm._vendor.elementpath.protocols import ElementProtocol, XsdElementProtocol, \
    XsdAttributeProtocol, XsdTypeProtocol, DocumentType, ElementType, \
    SchemaElemType, CommentType, ProcessingInstructionType
from opm._vendor.elementpath.helpers import match_wildcard, is_absolute_uri
from opm._vendor.elementpath.decoder import get_atomic_sequence
from opm._vendor.elementpath.etree import etree_iter_strings, is_etree_element_instance
