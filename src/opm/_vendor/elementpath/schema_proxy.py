...
from opm._vendor.elementpath.protocols import XsdTypeProtocol, XsdAttributeProtocol, \
    XsdElementProtocol, XsdSchemaProtocol
from opm._vendor.elementpath.aliases import AtomicType, XPath2ParserType
from opm._vendor.elementpath.etree import is_etree_element
