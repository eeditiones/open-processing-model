...
from opm._vendor.elementpath.protocols import LxmlElementProtocol, DocumentProtocol, \
    LxmlDocumentProtocol, XsdElementProtocol, DocumentType, ElementType, \
    SchemaElemType
from opm._vendor.elementpath.etree import is_etree_document, is_etree_element, is_etree_element_instance
from opm._vendor.elementpath.xpath_nodes import TextNode, ElementNode, SchemaElementNode, DocumentNode, \
